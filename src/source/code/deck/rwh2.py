...
theta=np.zeros(Length_of_Bridge)  ## rotation in z?
height=np.zeros(Length_of_Bridge) ## height in z?
...
def duplicate_distance(w,l):
    ...
    input: w - distance between two columns in x direction
           l - total length of bridge
    output: D - the coordinate of first face of column
...
# duplicate column, translation and rotation
