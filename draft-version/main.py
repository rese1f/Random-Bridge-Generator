...
# random_bridge = random.choice([1,2,3,4,5,6])
# random_bridge = random.choice([4])


def generate_bridge(random_bridge):
###########
    if random_bridge == 1:
        l_deck = 100
        h_deck = 10 
    ...
    ###########
        ...
        good_luck = Bg.SuspensionBridgeGenerator(0, h_deck, t_deck, w_column+t_column/2, 0, l_column, w_column, h_column)
    ...
    ###########
        ...
        good_luck = Bg.SteelGirderBridge()   

    ###########
    elif random_bridge == 6:
        good_luck = Bg.SlabBridge()       
